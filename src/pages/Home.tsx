    ...
    useEffect(() => {
        if (isAuthenticated) {
            getAccessTokenSilently().then((token) =>
                injectProfile(token, user?.email)
            );
        }
    }, [isAuthenticated]);
    ...
    return (
        <>
            ...
            >
                ...
                >
                    <Typography variant="h1">Swap • Grow • Thrive</Typography>
                    <Typography
                        variant="body1"
                        sx={{ mt: 2, maxWidth: 650, mx: "auto" }}
                    >
                        Exchange skills, not money! Our platform empowers you to
                        trade talents, learn from others and grow your expertise
                        — all while building a collaborative community where
                        everyone benefits. Skill up, share, and succeed together
                        in a cash-free, knowledge-driven economy. Your skills
                        are your currency!
                    </Typography>
                </Box>
            </Box>
            ...
            <Container
                maxWidth="lg"
                sx={{ textAlign: "center", my: 8, paddingX: { xs: 2, md: 8 } }}
            >
                <Box
                    sx={{
                        display: "flex",
                ...
                <Grid container spacing={4} sx={{ mt: 4 }}>
                    ...
                    >
                        <Typography variant="body1" fontSize={16}>
                            <strong>Swaply</strong> is an innovative skill
                            bartering app that reimagines the way people
                            exchange services by eliminating the need for
                            monetary transactions. Designed for individuals who
                            want to leverage their talents and expertise, Swaply
                            provides a dynamic platform where users can trade
                            skills directly with one another. Whether you're a
                            web developer in need of a logo design, a language
                            tutor looking for coding lessons, or someone who can
                            offer cooking classes in exchange for fitness
                            coaching, Swaply makes it easy to connect with
                ...
                <Grid container spacing={4} sx={{ mt: 4 }}>
                    ...
                    >
                        <Typography variant="body1" fontSize={16}>
                            By fostering a culture of collaboration and mutual
                            benefit, Swaply promotes the idea of
                            community-driven self-improvement. It empowers users
                            to reach their personal and professional goals
                            without financial limitations, making skill-building
                            accessible to a broader audience. Whether you're
                            looking to enhance your own abilities or find help
                            with a specific project, Swaply creates a win-win
                            environment where everyone can grow and succeed
                            through the power of skill sharing.
                        </Typography>
                    </Grid>
                    <Grid
                        item
                ...
                <Grid container spacing={4} sx={{ mt: 4 }}>
                    ...
                    >
                        <Typography variant="body1" fontSize={16}>
                            Users can create detailed profiles showcasing their
                            skills, qualifications, and availability, allowing
                            for seamless matchmaking based on needs and
                            interests. The app features an intuitive search
                            function that helps users quickly find potential
                            barter partners based on skill categories, location,
                            or user ratings. Swaply's secure messaging system
                            ensures that users can communicate, negotiate, and
                            finalize agreements within the app. It also includes
                            a review and rating feature that builds trust within
                            the community, ensuring transparency and
            ...
            <Divider
                variant="middle"
                sx={{ my: 4, width: "90%", margin: "0 auto" }}
            />
